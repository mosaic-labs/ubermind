...
module.exports = (config) => {
  return ({
    ...
    connectionString: mongo.connectionString || config.db || '',
  ...
  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || config.username || 'admin',
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || config.password || 'pass',
  },
